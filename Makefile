...
# Library Linking
INCLUDE = -Isrc/headers/ -Isrc/headers/csupport -Isrc/headers/imageSender -Isrc/headers/myrio -Isrc/headers/opencv2 -I"/usr/local/oecore-x86_64/sysroots/cortexa9-vfpv3-nilrt-linux-gnueabi/usr/include" -I"/usr/local/oecore-x86_64/sysroots/cortexa9-vfpv3-nilrt-linux-gnueabi/usr/include/c++/4.9.2/arm-nilrt-linux-gnueabi" -I/usr/local/include/opencv4/
